...
public class TetrisTileView extends TileView {
        ...
        private void loadTetrisImage()
        {
                ...
                loadTile(BACK_IMG, r.getDrawable(R.drawable.tetris_back));
                loadTile(MAGENTA_IMG, r.getDrawable(R.drawable.tetris_magenta));
                loadTile(YELLOW_IMG, r.getDrawable(R.drawable.tetris_yellow));
                loadTile(GREEN_IMG, r.getDrawable(R.drawable.tetris_green));
                loadTile(BLUE_IMG, r.getDrawable(R.drawable.tetris_blue));
                loadTile(ORANGE_IMG, r.getDrawable(R.drawable.tetris_orange));
                loadTile(CYAN_IMG, r.getDrawable(R.drawable.tetris_cyan));
                loadTile(RED_IMG, r.getDrawable(R.drawable.tetris_red));
